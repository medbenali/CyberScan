...
def read_routes():
    ...
    if addrfamily == socket.AF_INET:
        ...
        ifaddr = scapy_local.utils.inet_ntoa(ifreq[20:24])
...
def in6_getifaddr():
    ...
    for i in l:
        ...
        addr = scapy_local.utils6.in6_ptop(':'.join(addr))
...
def read_routes6():
    ...
    def proc2r(p):
        ...
        ret = ':'.join(ret)
        return scapy_local.utils6.in6_ptop(ret)
    ...
    for l in f.readlines():
        ...
        if dev == LOOPBACK_NAME:
            ...
            cset = scapy_local.utils6.construct_source_candidate_set(d, dp, devaddrs, LOOPBACK_NAME)
