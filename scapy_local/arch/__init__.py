...
if LINUX:
    from .linux import *
    if scapy_local.config.conf.use_pcap or scapy_local.config.conf.use_dnet:
...
if scapy_local.config.conf.iface is None:
    scapy_local.config.conf.iface = LOOPBACK_NAME
