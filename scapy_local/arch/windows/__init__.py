...
from scapy_local.config import conf,ConfClass
from scapy_local.error import Scapy_Exception,log_loading,log_runtime
from scapy_local.utils import atol, inet_aton, inet_ntoa, PcapReader
from scapy_local.base_classes import Gen, Net, SetGen
import scapy_local.plist as plist
from scapy_local.sendrecv import debug, srp1
from scapy_local.layers.l2 import Ether, ARP
from scapy_local.data import MTU, ETHER_BROADCAST, ETH_P_ARP
from functools import reduce

conf.use_pcap = 1
conf.use_dnet = 1
from scapy_local.arch import pcapdnet
from scapy_local.arch.pcapdnet import *
...
import scapy_local.layers.l2
scapy_local.layers.l2.getmacbyip = getmacbyip
...
import scapy_local.sendrecv
scapy_local.sendrecv.sndrcv = sndrcv
...
import scapy_local.sendrecv
scapy_local.sendrecv.sniff = sniff
